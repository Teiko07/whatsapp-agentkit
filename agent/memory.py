...
class Cita(Base):
    ...
    fecha: Mapped[str] = mapped_column(String(50))   # ISO o texto libre
    servicio: Mapped[str] = mapped_column(String(200))
    urgencia: Mapped[str] = mapped_column(String(20), default="baja")  # alta | media | baja
    estado: Mapped[str] = mapped_column(String(20), default="pendiente")
    creada: Mapped[datetime] = mapped_column(DateTime, default=datetime.utcnow)


class Lead(Base):
    """Leads / contactos comerciales calificados."""
    __tablename__ = "leads"
    ...
    estado: Mapped[str] = mapped_column(String(50), default="nuevo")  # nuevo, calificado, cerrado, perdido
